...
# MAGIC %md ##MLflow - serving models with Microsoft Azure ML
# MAGIC 
# MAGIC This notebook is part of a quickstart guide based on the [MLflow tutorial](https://www.mlflow.org/docs/latest/tutorial.html).
# MAGIC The [first part of the guide](https://docs.azuredatabricks.net/applications/mlflow/mlflow-training.html), **MLflow quickstart: model training and logging**, focuses on training a model and logging the training metrics, parameters, and model to the MLflow tracking server. 
# MAGIC 
...
# MAGIC ElasticNet models from the MLflow quickstart notebook in [part 1 of the quickstart guide](https://docs.azuredatabricks.net/applications/mlflow/mlflow-training.html).
...
# MAGIC 1. If you are running Databricks Runtime, uncomment and run Cmd 6 to install the required libraries. If you are running Databricks Runtime for Machine Learning, you can skip this step as the required libraries are already installed. 
